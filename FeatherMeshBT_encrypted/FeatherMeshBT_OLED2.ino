...
// This version supports Feather with OLED Wing
//
...
#define FEATHER_OLED  //for OLED display
//#define USE_AES_ENCRYPTION

#define N_NODES 2  //max 10 given RHRouter table dimensions
#define THIS_NODE 2  //white antenna COM12 *** hard coded node address *** (no EEPROM)
...
#define LOG_RCV_MSG_SERIAL
#define LOG_RCV_MSG_SERIAL1
#define LOG_RCV_MSG_OLED
...
void loop() {
  ...
  // check OLED buttons  BUTTON_C erases screen
#ifdef FEATHER_OLED
...
#ifdef LOG_RCV_MSG_SERIAL1
Serial1.print(buf);  //just the message
Serial1.println();
#endif

#ifdef FEATHER_OLED
#ifdef LOG_RCV_MSG_OLED
