These examples are derived from the original RadioHead RF22 RHRouter examples for a fixed-node network. Network connectivity, as described by the routing tables, is assumed to be direct.
