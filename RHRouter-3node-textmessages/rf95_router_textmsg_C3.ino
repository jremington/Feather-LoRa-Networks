...
RHRouter manager(driver, CLIENT3_ADDRESS);
...
void setup()
{
  ...
  */
  ...
  manager.addRouteTo(CLIENT1_ADDRESS, REPEATER2_ADDRESS);

  // check repeater connectivity
  
  Serial.print("Repeater check: ");
